...
CSJSV3.AUI.XueXiQingKuangForm = function(cfg) {
	var _me = this;
	var _toUpdWin;
	var _dataAgent;
	var _shenpiTGBtn;
				...
				fields : [
					{
						...
						canEmpty : false,
						canEmptyFor : '',
						style: 'width:303px;margin-right:50px;'
					}
				]
			}, 
			{
...
CSJSV3.AUI.XueXiQingKuangForm.prototype = new CSJSV3.SuperHelper();


CSJSV3.AUI.XueXiQingKuangList = function(cfg) {
	var _me = this;
	var _uiCore;
	var _form;
	var _dataGrid;
	...
	this.init = function(world) {
		/* 继承父级 */
		_me.base.init(world);
		_form = new CSJSV3.AUI.XueXiQingKuangForm({
...
CSJSV3.AUI.XueXiQingKuangList.prototype = new CSJSV3.SuperHelper();