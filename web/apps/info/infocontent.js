...
CSJSV3.AUI.CurrentListMgrView = function(cfg) {
	...
	{
		_uiCore = $('<div class="InfoArea"><div class="HeadArea">上海市废弃物管理处信息报送平台</div><div style="height:30px;">&nbsp;</div><div class="TitleArea"></div><div class="Title1Area"></div><div style="height:10px;">&nbsp;</div><div class="StateArea"></div><div style="height:20px;">&nbsp;</div><div class="ImgArea" style="display:none;margin-bottom:20px;"></div><div class="ContentArea"></div><div style="height:20px;">&nbsp;</div><div class="UploadFilesArea"></div></div>');
		cfg.uiCore = _uiCore;
		/* 继承父级 */
